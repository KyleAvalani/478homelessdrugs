...
cleaned_data$All.Ages[cleaned_data$All.Ages %in% c("*", "N")] <- 0
cleaned_data$X15.19[cleaned_data$X15.19 %in% c("*", "N")] <- 0
cleaned_data$X15.17[cleaned_data$X15.17 %in% c("*", "N")] <- 0
cleaned_data$X18.19[cleaned_data$X18.19 %in% c("*", "N")] <- 0
cleaned_data$X20.24[cleaned_data$X20.24 %in% c("*", "N")] <- 0
cleaned_data$X25.29[cleaned_data$X25.29 %in% c("*", "N")] <- 0
cleaned_data$X30.34[cleaned_data$X30.34 %in% c("*", "N")] <- 0
cleaned_data$X35.39[cleaned_data$X35.39 %in% c("*", "N")] <- 0
cleaned_data$X40.44[cleaned_data$X40.44 %in% c("*", "N")] <- 0
