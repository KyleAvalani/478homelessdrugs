                            ...
                            tabPanel(title = "Abortion Access vs Other Child Health Concerns", value = "tab4",
                                     ...
                                     sidebarLayout(
                                       ...
                                       mainPanel(
                                         ...
                                         tags$li("med_f_rate: The median number of foster children per million people for each level of access. Places with restricted access to abortions had a much higher number of foster children per capita, states with severly restricted access had the lowest median but also had the largest spread."),
